...
public class AprioriTest {
    ...
    public void tearDown() {
     ...
     @Test
     public void test() {
    	 List<Node> result = (LinkedList<Node>) new Apriori().execute("src/test/resources/test.txt", ",", ",", 3);
         assertEquals(resultList,result);
         
         List<Node> result2 = (LinkedList<Node>) new Apriori().execute("src/test/resources/test2.txt", "|", ",", 4);
         assertEquals(resultList2,result2);

         List<Node> result3 = (LinkedList<Node>) new Apriori().execute("src/test/resources/test3.txt", "|", ",", 3);
